...
class ForSpecial extends GetxController {
  int space = 24;
  int space2 = 8;
  ...
  List<String> ListData = [
    'I-Site: ตรวจสอบอุปกรณ์ I-Site',
    'AGV: ตรวจสอบระบบ Autopilot (AGV) Sensor, Scanner, Display status',
    'AGV: ตรวจสอบอุปกรณ์ทำงานร่วมกับ AGV "Charger Pole, Reflector"',
  ];
  List<String> typeData = ['I', 'I,T,W', 'I,T,W'];
